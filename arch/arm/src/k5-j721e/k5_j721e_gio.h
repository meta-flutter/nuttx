/****************************************************************************
 * arch/arm/src/k5_j721e/k5_j721e_gio.h
 *
...
#ifndef __ARCH_ARM_SRC_K5_J721E_K5_J721E_GIO_H
#define __ARCH_ARM_SRC_K5_J721E_K5_J721E_GIO_H
...
/* Bit-encoded input to k5_j721e_configgio() **********************************/
...
static inline uintptr_t k5_j721e_gio_base(gio_pinset_t cfgset)
{
  int port = (cfgset & GIO_PORT_MASK) >> GIO_PORT_SHIFT;
  return K5_J721E_GIO_PORTBASE(port);
}

/****************************************************************************
 * Name: k5_j721e_gio_port
 *
 * Description:
...
static inline int k5_j721e_gio_port(gio_pinset_t cfgset)
{
  return (cfgset & GIO_PORT_MASK) >> GIO_PORT_SHIFT;
}

/****************************************************************************
 * Name: k5_j721e_gio_pin
 *
 * Description:
...
static inline int k5_j721e_gio_pin(gio_pinset_t cfgset)
{
  return (cfgset & GIO_PIN_MASK) >> GIO_PIN_SHIFT;
}

/****************************************************************************
 * Name: k5_j721e_gio_pinmask
 *
 * Description:
...
static inline int k5_j721e_gio_pinmask(gio_pinset_t cfgset)
{
...
/****************************************************************************
 * Name: k5_j721e_gioirq_initialize
 *
 * Description:
...
#else
#  define k5_j721e_gioirq_initialize()
#endif
...
#else
#  define k5_j721e_gioirqenable(irq)
#endif
...
#else
#  define k5_j721e_gioirqdisable(irq)
#endif
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_K5_J721E_K5_J721E_GIO_H */
