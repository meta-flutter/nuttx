/****************************************************************************
 * arch/arm/src/k5_j721e/hardware/k5_j721e_sys.h
 *
...
#ifndef __ARCH_ARM_SRC_K5_J721E_HARDWARE_K5_J721E_SYS_H
#define __ARCH_ARM_SRC_K5_J721E_HARDWARE_K5_J721E_SYS_H
...
#define K5_J721E_TITCM_LPOTRIM_OFFSET     0x01b4
#define K5_J721E_TITCM_LPOTRIM            (K5_J721E_TITCM_BASE+K5_J721E_TITCM_LPOTRIM_OFFSET)
#  define K5_J721E_TITCM_LPOTRIM_SHIFT    (16)    /* Bits 16-31: LPO trim value */
#  define K5_J721E_TITCM_LPOTRIM_MASK     (0xffff << K5_J721E_TITCM_LPOTRIM_SHIFT)

/* Register Offsets *********************************************************/

#define K5_J721E_SYS_PC1_OFFSET           0x0000  /* SYS Pin Control Register 1 */
#define K5_J721E_SYS_PC2_OFFSET           0x0004  /* SYS Pin Control Register 2 */
#define K5_J721E_SYS_PC3_OFFSET           0x0008  /* SYS Pin Control Register 3 */
#define K5_J721E_SYS_PC4_OFFSET           0x000c  /* SYS Pin Control Register 4 */
#define K5_J721E_SYS_PC5_OFFSET           0x0010  /* SYS Pin Control Register 5 */
#define K5_J721E_SYS_PC6_OFFSET           0x0014  /* SYS Pin Control Register 6 */
#define K5_J721E_SYS_PC7_OFFSET           0x0018  /* SYS Pin Control Register 7 */
#define K5_J721E_SYS_PC8_OFFSET           0x001c  /* SYS Pin Control Register 8 */
#define K5_J721E_SYS_PC9_OFFSET           0x0020  /* SYS Pin Control Register 9 */
#define K5_J721E_SYS_CSDIS_OFFSET         0x0030  /* Clock Source Disable Register */
#define K5_J721E_SYS_CSDISSET_OFFSET      0x0034  /* Clock Source Disable Set Register */
#define K5_J721E_SYS_CSDISCLR_OFFSET      0x0038  /* Clock Source Disable Clear Register */
#define K5_J721E_SYS_CDDIS_OFFSET         0x003c  /* Clock Domain Disable Register */
#define K5_J721E_SYS_CDDISSET_OFFSET      0x0040  /* Clock Domain Disable Set Register */
#define K5_J721E_SYS_CDDISCLR_OFFSET      0x0044  /* Clock Domain Disable Clear Register */
#define K5_J721E_SYS_GHVSRC_OFFSET        0x0048  /* GCLK, HCLK, VCLK, and VCLK2 Source Register */
#define K5_J721E_SYS_VCLKASRC_OFFSET      0x004c  /* Peripheral Asynchronous Clock Source Register */
#define K5_J721E_SYS_RCLKSRC_OFFSET       0x0050  /* RTI Clock Source Register */
#define K5_J721E_SYS_CSVSTAT_OFFSET       0x0054  /* Clock Source Valid Status Register */
#define K5_J721E_SYS_MSTGCR_OFFSET        0x0058  /* Memory Self-Test Global Control Register */
#define K5_J721E_SYS_MINITGCR_OFFSET      0x005c  /* Memory Hardware Initialization Global Control Register */
#define K5_J721E_SYS_MSIENA_OFFSET        0x0060  /* Memory Self-Test/Initialization Enable Register */
#define K5_J721E_SYS_MSTFAIL_OFFSET       0x0064  /* Memory Self-Test Fail Status Register */
#define K5_J721E_SYS_MSTCGSTAT_OFFSET     0x0068  /* MSTC Global Status Register */
#define K5_J721E_SYS_MINISTAT_OFFSET      0x006c  /* Memory Hardware Initialization Status Register */
#define K5_J721E_SYS_PLLCTL1_OFFSET       0x0070  /* PLL Control Register 1 */
#define K5_J721E_SYS_PLLCTL2_OFFSET       0x0074  /* PLL Control Register 2 */
#define K5_J721E_SYS_PC10_OFFSET          0x0078  /* SYS Pin Control Register 10 */
#define K5_J721E_SYS_DIEIDL_OFFSET        0x007c  /* Die Identification Register, Lower Word */
#define K5_J721E_SYS_DIEIDH_OFFSET        0x0080  /* Die Identification Register, Upper Word */
#define K5_J721E_SYS_LPOMONCTL_OFFSET     0x0088  /* LPO/Clock Monitor Control Register */
#define K5_J721E_SYS_CLKTEST_OFFSET       0x008c  /* Clock Test Register */
#define K5_J721E_SYS_DFTCTRLREG_OFFSET    0x0090  /* DFT Control Register */
#define K5_J721E_SYS_DFTCTRLREG2_OFFSET   0x0094  /* DFT Control Register 2 */
#define K5_J721E_SYS_GPREG1_OFFSET        0x00a0  /* General Purpose Register */
#define K5_J721E_SYS_IMPFASTS_OFFSET      0x00a8  /* Imprecise Fault Status Register */
#define K5_J721E_SYS_IMPFTADD_OFFSET      0x00ac  /* Imprecise Fault Write Address Register */
#define K5_J721E_SYS_SSIR1_OFFSET         0x00b0  /* System Software Interrupt Request 1 Register */
#define K5_J721E_SYS_SSIR2_OFFSET         0x00b4  /* System Software Interrupt Request 2 Register */
#define K5_J721E_SYS_SSIR3_OFFSET         0x00b8  /* System Software Interrupt Request 3 Register */
#define K5_J721E_SYS_SSIR4_OFFSET         0x00bc  /* System Software Interrupt Request 4 Register */
#define K5_J721E_SYS_RAMGCR_OFFSET        0x00c0  /* RAM Control Register */
#define K5_J721E_SYS_BMMCR1_OFFSET        0x00c4  /* Bus Matrix Module Control Register 1 */
#define K5_J721E_SYS_CPURSTCR_OFFSET      0x00cc  /* CPU Reset Control Register */
#define K5_J721E_SYS_CLKCNTL_OFFSET       0x00d0  /* Clock Control Register */
#define K5_J721E_SYS_ECPCNTL_OFFSET       0x00d4  /* ECP Control Register */
#define K5_J721E_SYS_DEVCR1_OFFSET        0x00dc  /* DEV Parity Control Register 1 */
#define K5_J721E_SYS_ECR_OFFSET           0x00e0  /* System Exception Control Register */
#define K5_J721E_SYS_ESR_OFFSET           0x00e4  /* System Exception Status Register */
#define K5_J721E_SYS_TASR_OFFSET          0x00e8  /* System Test Abort Status Register */
#define K5_J721E_SYS_GLBSTAT_OFFSET       0x00ec  /* Global Status Register */
#define K5_J721E_SYS_DEVID_OFFSET         0x00f0  /* Device Identification Register */
#define K5_J721E_SYS_SSIVEC_OFFSET        0x00f4  /* Software Interrupt Vector Register */
#define K5_J721E_SYS_SSIF_OFFSET          0x00f8  /* System Software Interrupt Flag Register */

/* Register Addresses *******************************************************/

#define K5_J721E_SYS_PC1                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC1_OFFSET)
#define K5_J721E_SYS_PC2                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC2_OFFSET)
#define K5_J721E_SYS_PC3                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC3_OFFSET)
#define K5_J721E_SYS_PC4                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC4_OFFSET)
#define K5_J721E_SYS_PC5                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC5_OFFSET)
#define K5_J721E_SYS_PC6                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC6_OFFSET)
#define K5_J721E_SYS_PC7                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC7_OFFSET)
#define K5_J721E_SYS_PC8                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC8_OFFSET)
#define K5_J721E_SYS_PC9                  (K5_J721E_SYS_BASE+K5_J721E_SYS_PC9_OFFSET)
#define K5_J721E_SYS_CSDIS                (K5_J721E_SYS_BASE+K5_J721E_SYS_CSDIS_OFFSET)
#define K5_J721E_SYS_CSDISSET             (K5_J721E_SYS_BASE+K5_J721E_SYS_CSDISSET_OFFSET)
#define K5_J721E_SYS_CSDISCLR             (K5_J721E_SYS_BASE+K5_J721E_SYS_CSDISCLR_OFFSET)
#define K5_J721E_SYS_CDDIS                (K5_J721E_SYS_BASE+K5_J721E_SYS_CDDIS_OFFSET)
#define K5_J721E_SYS_CDDISSET             (K5_J721E_SYS_BASE+K5_J721E_SYS_CDDISSET_OFFSET)
#define K5_J721E_SYS_CDDISCLR             (K5_J721E_SYS_BASE+K5_J721E_SYS_CDDISCLR_OFFSET)
#define K5_J721E_SYS_GHVSRC               (K5_J721E_SYS_BASE+K5_J721E_SYS_GHVSRC_OFFSET)
#define K5_J721E_SYS_VCLKASRC             (K5_J721E_SYS_BASE+K5_J721E_SYS_VCLKASRC_OFFSET)
#define K5_J721E_SYS_RCLKSRC              (K5_J721E_SYS_BASE+K5_J721E_SYS_RCLKSRC_OFFSET)
#define K5_J721E_SYS_CSVSTAT              (K5_J721E_SYS_BASE+K5_J721E_SYS_CSVSTAT_OFFSET)
#define K5_J721E_SYS_MSTGCR               (K5_J721E_SYS_BASE+K5_J721E_SYS_MSTGCR_OFFSET)
#define K5_J721E_SYS_MINITGCR             (K5_J721E_SYS_BASE+K5_J721E_SYS_MINITGCR_OFFSET)
#define K5_J721E_SYS_MSIENA               (K5_J721E_SYS_BASE+K5_J721E_SYS_MSIENA_OFFSET)
#define K5_J721E_SYS_MSTFAIL              (K5_J721E_SYS_BASE+K5_J721E_SYS_MSTFAIL_OFFSET)
#define K5_J721E_SYS_MSTCGSTAT            (K5_J721E_SYS_BASE+K5_J721E_SYS_MSTCGSTAT_OFFSET)
#define K5_J721E_SYS_MINISTAT             (K5_J721E_SYS_BASE+K5_J721E_SYS_MINISTAT_OFFSET)
#define K5_J721E_SYS_PLLCTL1              (K5_J721E_SYS_BASE+K5_J721E_SYS_PLLCTL1_OFFSET)
#define K5_J721E_SYS_PLLCTL2              (K5_J721E_SYS_BASE+K5_J721E_SYS_PLLCTL2_OFFSET)
#define K5_J721E_SYS_PC10                 (K5_J721E_SYS_BASE+K5_J721E_SYS_PC10_OFFSET)
#define K5_J721E_SYS_DIEIDL               (K5_J721E_SYS_BASE+K5_J721E_SYS_DIEIDL_OFFSET)
#define K5_J721E_SYS_DIEIDH               (K5_J721E_SYS_BASE+K5_J721E_SYS_DIEIDH_OFFSET)
#define K5_J721E_SYS_LPOMONCTL            (K5_J721E_SYS_BASE+K5_J721E_SYS_LPOMONCTL_OFFSET)
#define K5_J721E_SYS_CLKTEST              (K5_J721E_SYS_BASE+K5_J721E_SYS_CLKTEST_OFFSET)
#define K5_J721E_SYS_DFTCTRLREG           (K5_J721E_SYS_BASE+K5_J721E_SYS_DFTCTRLREG_OFFSET)
#define K5_J721E_SYS_DFTCTRLREG2          (K5_J721E_SYS_BASE+K5_J721E_SYS_DFTCTRLREG2_OFFSET)
#define K5_J721E_SYS_GPREG1               (K5_J721E_SYS_BASE+K5_J721E_SYS_GPREG1_OFFSET)
#define K5_J721E_SYS_IMPFASTS             (K5_J721E_SYS_BASE+K5_J721E_SYS_IMPFASTS_OFFSET)
#define K5_J721E_SYS_IMPFTADD             (K5_J721E_SYS_BASE+K5_J721E_SYS_IMPFTADD_OFFSET)
#define K5_J721E_SYS_SSIR1                (K5_J721E_SYS_BASE+K5_J721E_SYS_SSIR1_OFFSET)
#define K5_J721E_SYS_SSIR2                (K5_J721E_SYS_BASE+K5_J721E_SYS_SSIR2_OFFSET)
#define K5_J721E_SYS_SSIR3                (K5_J721E_SYS_BASE+K5_J721E_SYS_SSIR3_OFFSET)
#define K5_J721E_SYS_SSIR4                (K5_J721E_SYS_BASE+K5_J721E_SYS_SSIR4_OFFSET)
#define K5_J721E_SYS_RAMGCR               (K5_J721E_SYS_BASE+K5_J721E_SYS_RAMGCR_OFFSET)
#define K5_J721E_SYS_BMMCR1               (K5_J721E_SYS_BASE+K5_J721E_SYS_BMMCR1_OFFSET)
#define K5_J721E_SYS_CPURSTCR             (K5_J721E_SYS_BASE+K5_J721E_SYS_CPURSTCR_OFFSET)
#define K5_J721E_SYS_CLKCNTL              (K5_J721E_SYS_BASE+K5_J721E_SYS_CLKCNTL_OFFSET)
#define K5_J721E_SYS_ECPCNTL              (K5_J721E_SYS_BASE+K5_J721E_SYS_ECPCNTL_OFFSET)
#define K5_J721E_SYS_DEVCR1               (K5_J721E_SYS_BASE+K5_J721E_SYS_DEVCR1_OFFSET)
#define K5_J721E_SYS_ECR                  (K5_J721E_SYS_BASE+K5_J721E_SYS_ECR_OFFSET)
#define K5_J721E_SYS_ESR                  (K5_J721E_SYS_BASE+K5_J721E_SYS_ESR_OFFSET)
#define K5_J721E_SYS_TASR                 (K5_J721E_SYS_BASE+K5_J721E_SYS_TASR_OFFSET)
#define K5_J721E_SYS_GLBSTAT              (K5_J721E_SYS_BASE+K5_J721E_SYS_GLBSTAT_OFFSET)
#define K5_J721E_SYS_DEVID                (K5_J721E_SYS_BASE+K5_J721E_SYS_DEVID_OFFSET)
#define K5_J721E_SYS_SSIVEC               (K5_J721E_SYS_BASE+K5_J721E_SYS_SSIVEC_OFFSET)
#define K5_J721E_SYS_SSIF                 (K5_J721E_SYS_BASE+K5_J721E_SYS_SSIF_OFFSET)
...
#if defined(CONFIG_ARCH_CHIP_K5_J721E)
  /* From K5_J721ELS0x32 Data Sheet */
...
#endif /* __ARCH_ARM_SRC_K5_J721E_HARDWARE_K5_J721E_SYS_H */
