/****************************************************************************
 * boards/arm/k5-j721e/beaglebone-ai64-k5/src/beaglebone_ai64_k5_buttons.c
 *
...
#include "beaglebone_ai64_k5_gio.h"
#include "beaglebone-ai64-k5.h"
  ...
  if (irqhandler != NULL)
    {
      ...
      beaglebone_ai64_k5_gioirq(pinset);
      irq_attach(irq, irqhandler, arg);
      beaglebone_ai64_k5_gioirqenable(irq);
    }
  else
    {
      ...
      irq_detach(irq);
      beaglebone_ai64_k5_gioirqdisable(irq);
    }
...
uint32_t board_button_initialize(void)
{
  ...
  beaglebone_ai64_k5_configgio(GIO_BUTTON);
  return NUM_BUTTONS;
}
...
{
  return beaglebone_ai64_k5_gioread(GIO_BUTTON) ? BUTTON_GIOA7_BIT : 0;
}
